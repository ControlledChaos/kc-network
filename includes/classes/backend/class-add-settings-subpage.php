...
class Add_Settings_Subpage extends Add_Subpage {
	 ...
	 */
	protected $menu_slug = KCN_BASENAME . '-sample-subpage';
	...
	protected function heading() {
		return __( 'Sample Submenu Page', 'kc-network' );
	}
	...
	protected function content() {
		...
		include_once KCN_PATH . 'views/backend/pages/sample-page-content.php';
