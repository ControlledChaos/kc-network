...
final class Customizer_Reset {
	...
	public function scripts() {
		...
		wp_enqueue_script( 'kcn-customizer-reset', KCN_URL . 'assets/js/customizer-reset' . $suffix . '.js', [ 'jquery' ], '20150120' );

		// Localize the above script.
		wp_localize_script( 'kcn-customizer-reset', 'KCN_CustomizerReset', [
			'reset'   => __( 'Reset', 'kc-network' ),
			'confirm' => __( 'Warning! This will remove all changes made to this theme via the Customizer. This action is irreversible.', 'kc-network' ),
			'nonce'   => [
